# Assignment 15: Retrieval-Augmented Generation (RAG)
...
**Expected file name:**  
`Assignment-15_RAG_<your_name>_<your_surname>.ipynb`

---

### Steps to upload the assignment solution

- Upload the solved notebook (`Assignment-15_RAG_<your_name>_<your_surname>.ipynb`) in the google drive location: https://drive.google.com/drive/folders/1VWUTpDeClrnoG5kfw0rPWfcodGzh7diN?usp=sharing
