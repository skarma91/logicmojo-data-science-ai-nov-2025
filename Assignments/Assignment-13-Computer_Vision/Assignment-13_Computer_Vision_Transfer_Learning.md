...
**Dataset:** The dataset `pizza_steak_sushi.zip` is uploaded in the same folder.
...
**Expected file name:**  
`Assignment-13_CNN_Transfer_Learning_<your_name>_<your_surname>.ipynb`
...
**Expected file name:**  
`Assignment-13_CNN_Transfer_Learning_Report_<your_name>_<your_surname>.pdf`
...
- Upload the solved notebook (`Assignment-13_CNN_Transfer_Learning_<your_name>_<your_surname>.ipynb`) and report document (`Assignment-13_CNN_Transfer_Learning_Report_<your_name>_<your_surname>.pdf`) in the google drive location: https://drive.google.com/drive/folders/1xQ-gpxweC1y1p0QZ_vyjZ1ug5-3RD9AS?usp=sharing
