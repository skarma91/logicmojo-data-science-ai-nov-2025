# Assignment 14: Sequence-to-Sequence (Seq2Seq) Modeling with Attention in NLP
...
**Dataset:** The dataset `eng-deu.csv` is uploaded in the same folder.
...
**Expected file name:**  
`Assignment-14_Seq2Seq_Attention_<your_name>_<your_surname>.ipynb`

**Reference Notebook**

To guide your implementation, you may refer to the following example notebook:
[French to English using Seq2Seq with Attention](https://github.com/skarma91/logicmojo-data-science-ai-nov-2025/blob/main/Lecture_materials/Class-51-Seq2Seq-Attention_Mechanism/french_to_english_using_seq2seq_attention.ipynb)
...
**Expected file name:**  
`Assignment-14_Seq2Seq_Attention_Report_<your_name>_<your_surname>.pdf`
...
- Upload the solved notebook (`Assignment-14_Seq2Seq_Attention_<your_name>_<your_surname>.ipynb`) and report document (`Assignment-14_Seq2Seq_Attention_Report_<your_name>_<your_surname>.pdf`) in the google drive location: https://drive.google.com/drive/folders/1-3WntZDYptux4XCwc2oArdaLML7tTrJ3?usp=drive_link
